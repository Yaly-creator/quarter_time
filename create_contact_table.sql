...
DROP POLICY IF EXISTS "Allow service role to insert contact messages" ON public.contact_messages;
...
DROP POLICY IF EXISTS "Allow service role to select contact messages" ON public.contact_messages;
...
DROP POLICY IF EXISTS "Allow users to view their own contact messages" ON public.contact_messages;
